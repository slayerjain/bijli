...
describe('Starting tests for bijli-app', function() {
  ...
  it('website title should be bijli-app', () => {
    page.navigateTo('/');
    return browser.getTitle().then((result)=>{
      expect(result).toBe('bijli-app');
    })
  });

  it('navbar-brand should be decentralized-energy-network@0.1.11',() => {
    var navbarBrand = element(by.css('.navbar-brand')).getWebElement();
    expect(navbarBrand.getText()).toBe('decentralized-energy-network@0.1.11');
  });
